...
export default function App(props) {
  ...
  return (
    ...
    <StatusBar style="auto" />
      ...
      //Aqui insiro o array que quero percorrer, no caso quero percorrer o array Times
         data={times}


        
        //Aqui faço uma variável para percorrer este array
         renderItem={ ( {item} ) =>  ( 
         ...
         <Clubes
           ...
           //Aqui passo todos as chaves que tranformei em props lá em meu componente de Clubes, só que com a variável item
           //para que está percorrendo nosso array 
           //nome, anoFundacao, mascote, imagem, jogadores
