...
import Comissao from "../componentes/Comissao";
...
export default function JogadorScreen() {
    ...
    return (
        ...
        <FlatList
            ...
            <Comissao
              nome = {brasil.nome}
              imagem = {brasil.imagem}
              treinador = {brasil.treinador}
              titulos_copa_mundo = {brasil.titulos_copa_mundo}
              administrador = {brasil.administrador}
              estadio = {brasil.estadio}
